...
export interface NexusGenInterfaces {
  Edge:
    | NexusGenRootTypes['MemoryConnectionEdge']
    | NexusGenRootTypes['SiteConnectionEdge']
    | NexusGenRootTypes['UserConnectionEdge'];
  Node:
    | NexusGenRootTypes['Memory']
    | NexusGenRootTypes['Site']
